...
namespace nomic {
	...
	namespace graphic {
		...
		static const std::string NOMIC_GRAPHIC_MANAGER_EXCEPTION_STR[] = {
			NOMIC_GRAPHIC_MANAGER_EXCEPTION_HEADER "Graphic manager external exception",
			...
			NOMIC_GRAPHIC_MANAGER_EXCEPTION_HEADER "Primitive does not exist",
