...
namespace nomic {
	...
	namespace graphic {
		...
		enum {
			NOMIC_GRAPHIC_PROGRAM_ATTRIBUTE_NOT_FOUND = 0,
			NOMIC_GRAPHIC_PROGRAM_DUPLICATE_ATTRIBUTE,
			NOMIC_GRAPHIC_PROGRAM_DUPLICATE_SHADER,
			NOMIC_GRAPHIC_PROGRAM_EXCEPTION_EXTERNAL,
			NOMIC_GRAPHIC_PROGRAM_INVALID_ATTRIBUTE,
			NOMIC_GRAPHIC_PROGRAM_INVALID_LOCATION,
