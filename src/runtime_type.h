...
namespace nomic {
	...
	enum {
		NOMIC_RUNTIME_EXCEPTION_EXTERNAL = 0,
		NOMIC_RUNTIME_EXCEPTION_START,
		NOMIC_RUNTIME_EXCEPTION_STARTED,
		NOMIC_RUNTIME_EXCEPTION_STOPPED,
	};

	#define NOMIC_RUNTIME_EXCEPTION_MAX NOMIC_RUNTIME_EXCEPTION_STOPPED

	static const std::string NOMIC_RUNTIME_EXCEPTION_STR[] = {
		NOMIC_RUNTIME_EXCEPTION_HEADER "Runtime external exception",
		NOMIC_RUNTIME_EXCEPTION_HEADER "Runtime failed to start",
		NOMIC_RUNTIME_EXCEPTION_HEADER "Runtime is started",
		NOMIC_RUNTIME_EXCEPTION_HEADER "Runtime is stopped",
		};
