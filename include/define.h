...
namespace nomic {
	...
	#define BLOCK_CACTUS_MAX 2
	#define BLOCK_CACTUS_AVERAGE 1
	...
	#define BLOCK_FLOWER_HEIGHT_MAX BLOCK_LEVEL_GRASS_STEP
	#define BLOCK_FLOWER_HEIGHT_MIN BLOCK_LEVEL_GRASS
	#define BLOCK_HEIGHT_ORE_COAL BLOCK_LEVEL_ALPINE_PEAK
	#define BLOCK_HEIGHT_ORE_DIAMOND 12
	#define BLOCK_HEIGHT_ORE_GOLD 50
	#define BLOCK_HEIGHT_ORE_IRON 80
	#define BLOCK_HEIGHT_ORE_MIN 3
	...
	#define BLOCK_ORE_COAL_MAX 32
	#define BLOCK_ORE_COAL_MIN 8
	#define BLOCK_ORE_DIAMOND_MAX 4
	#define BLOCK_ORE_DIAMOND_MIN 0
	#define BLOCK_ORE_GOLD_MAX 8
	#define BLOCK_ORE_GOLD_MIN 0
	#define BLOCK_ORE_IRON_MAX 16
	#define BLOCK_ORE_IRON_MIN 2
	#define BLOCK_RADIUS (BLOCK_WIDTH / 2.f)
	#define BLOCK_SCALE_DEFAULT 1.f
	#define BLOCK_SCALE_MIN 0.f
	#define BLOCK_SEAGRASS_AVERAGE 4
	#define BLOCK_SEAGRASS_MAX 6
	#define BLOCK_SMALL_OFFSET 0.065f
	#define BLOCK_SUGAR_CANE_MAX 4
	#define BLOCK_SUGAR_CANE_AVERAGE 3
	#define BLOCK_TREE_OAK_AVERAGE 7
	#define BLOCK_TREE_OAK_CAP_RADIUS (BLOCK_TREE_OAK_CAP_WIDTH / 2)
	#define BLOCK_TREE_OAK_CAP_WIDTH 2
	...
	#define CHUNK_SPAWN_DEFERRED_TIMEOUT 60
	...
	//#define RUNTIME_DELAY_RENDERING
