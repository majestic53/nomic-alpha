...
namespace nomic {
	...
	#define DISPLAY_DEFAULT_TITLE NOMIC " " STRING_CONCAT(NOMIC_VERSION_MAJOR) "." STRING_CONCAT(NOMIC_VERSION_MINOR) \
		"." STRING_CONCAT(NOMIC_VERSION_WEEK) "." STRING_CONCAT(NOMIC_VERSION_REVISION) "-" NOMIC_VERSION_RELEASE
	...
	#define NOMIC_VERSION_WEEK 1725
	...
	#define TEXTURE_FILTER_MAG_DEFAULT GL_LINEAR
